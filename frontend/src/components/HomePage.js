        ...
        <div className='homepage'>
          <div className='header'>
            <div className='homepage__header-section'>
              ...
              <p className='section-description header-decription'>Custom packaging can turn your brand into the total package with full customization, instant quoting, and fast turnarounds.</p>
              <a className='section-button' href='#inspiration'>GET INSPIRED</a>
              <p className='homepage__header-section__brand-header'>trusted by over 2,500 companies</p>
            </div>
            <img className='header-img' src='https://packstreet-bucket.s3-us-west-2.amazonaws.com/homepage-hero-packlane.jpg' />
          </div>
          <ConnectedPackageBases />
          <div id='inspiration' className='homepage__get-inspired-container'>
