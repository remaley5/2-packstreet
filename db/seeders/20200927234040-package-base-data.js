...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('PackageBases', [{
      ...
      unitPrice: 2.06,
      defaultImage: 'https://packstreet-bucket.s3-us-west-2.amazonaws.com/bases/mailer.png',
      headerImage: 'https://packstreet-bucket.s3-us-west-2.amazonaws.com/bases/base-headers/mailer-box.jpg',
      ...
      description1: "Command attention on retail shelves with our product boxes made from SBS paperboard. Perfect for beauty packaging, supplements, and chocolate.",
      unitPrice: 2.10,
      defaultImage: 'https://packstreet-bucket.s3-us-west-2.amazonaws.com/bases/folding.png',
      headerImage: 'https://packstreet-bucket.s3-us-west-2.amazonaws.com/bases/base-headers/product-box.jpg',
      buttonText: 'Meet our carton',
      description2Header: 'Light as a feather',
      description2: "With a refined feel that is excellent for retail shelves, our product boxes are made using 16pt lightweight SBS paperboard. Cartons can hold up to 1 lb but don't like to go it alone. They can be perfectly paired with one of our mailer or shipping boxes if you need to drop them in the mail.",
      createdAt: new Date(),
      updatedAt: new Date()
    },
    {
      ...
      unitPrice: 4.28,
      defaultImage: 'https://packstreet-bucket.s3-us-west-2.amazonaws.com/bases/shipping.png',
      headerImage: 'https://packstreet-bucket.s3-us-west-2.amazonaws.com/bases/base-headers/shipper-box.jpg',
    ...
    },
    {
      ...
      unitPrice: 1.18,
      defaultImage: 'https://packstreet-bucket.s3-us-west-2.amazonaws.com/bases/econoflex.png',
      headerImage: 'https://packstreet-bucket.s3-us-west-2.amazonaws.com/bases/base-headers/econoflex-box.png',
